    ...
    //write your code here
     ...
     await Promise.all(assets.map(async (asset) => {
         ...
         const metadata = {
             ...
             image: `ipfs://${result.IpfsHash}/Users/hp/AminaAlgo/arc3-nft-elansariamina/assets/nft/${asset.file}`,
             image_integrity: `sha256-${integrity.base64}`,
             image_mimetype: asset.image_mimetype,
             properties: {
                 file_url: `https://gateway.pinata.cloud/ipfs/${result.IpfsHash}/Users/hp/AminaAlgo/arc3-nft-elansariamina/assets/nft/${asset.file}`,
